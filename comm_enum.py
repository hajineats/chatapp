...
SENUM_SOMEONEJOINEDGROUP_len = 4
SENUM_SOMEONEJOINEDGROUP = "SOMEONE_JOINED_THE_GROUP"
SENUM_SOMEONEJOINEDGROUP_GROUPNAME = 2
SENUM_SOMEONEJOINEDGROUP_GROUPOBJECTWITHLISTOFPARTICIPANTS = 3
...
# a client says join the group to some other client
CENUM_GROUPINVITATION_len = 5
CENUM_GROUPINVITATION = "GROUPINVITATION"
CENUM_GROUPINVITATION_GROUPNAME = 2
CENUM_GROUPINVITATION_INVITER_NICKSOCK = 3
CENUM_GROUPINVITATION_INVITEE_NICKSOCK = 4
